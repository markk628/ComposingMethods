...
############################
def split_sentence_into_array(sentence):  # TODO: Rename this function to reflect what it's doing.
    words = sentence[0:].split(' ')
    return words

print(split_sentence_into_array('If you were a vegetable, you’d be a ‘cute-cumber.'))